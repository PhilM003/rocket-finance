...
class _EditTransactionScreenState extends State<EditTransactionScreen> {
  ...
  final List<String> _expenseCategories = ['Food', 'Rent', 'Utilities', 'Snacks', 'Others'];
  ...
  void initState() {
    ...
    _accountController = TextEditingController(text: widget.transaction.accountName);
    _selectedType = widget.transaction.type == 'income' ? 'income' : 'expense';
  ...
  void _handleSaveTransaction() {
    if (_validateForm()) {
      // Delete old and add new (since no edit in repo)
